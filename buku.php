    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <?php if(isset($_SESSION["akun"])): ?>
          ...
          <?php if($_SESSION["role"]=="Admin"): ?>
            <li class="nav-item">
              <a class="nav-link text-white active bg-gradient-primary " href="buku.php">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="material-icons opacity-10">book</i>
                </div>
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <div class="d-flex justify-content-between align-items-center"> 
                    <span class="h6 text-white text-capitalize ps-3">Daftar Buku</span>
                    <div class="mx-4">
                        <a href="add_buku.php" class="btn btn-success material-icons">add</a>
                    </div>
                </div>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Author Buku</th>
                    ...
                    <?php while($buku = mysqli_fetch_array($result)): ?>
                      <tr>
                        <td class="align-middle text-center">
                          <h6 class="mb-0 text-sm"><?=$buku["judul_buku"]?></h6>
                        </td>
                        <td class="align-middle text-center">
                          <p class="text-xs text-secondary mb-0"><?=$buku["author_buku"]?></p>
                        </td>
                        <td class="align-middle text-center">
                            <a href="edit_buku.php?id=<?=$buku["id_buku"]?>" class="btn btn-success material-icons">edit</a>
                            <a href="hapus_buku.php?id=<?=$buku["id_buku"]?>" onclick="return confirm('Apakah yakin ingin menghapus buku <?=$buku["judul_buku"]?>?')" class="btn btn-danger material-icons">delete</a>
                        </td>
                      </tr>
                    <?php endwhile ?>
                  </tbody>
